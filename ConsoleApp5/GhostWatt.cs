...
namespace ConsoleApp5
{
    internal class Program
    {
        ...
        // totalWatts = total standby watts
        // 24 = hours per day
        // 30 = days per month
        // /1000 = watts to kWh
        ...
        // appliances = appliance + standby watts
        // selectedDevices = selected appliance data
        // unpluggedList = unplugged appliances
        ...
        static void TapToAddInventory()
        {
            ...
            foreach (KeyValuePair<string, double> item in appliances)
            {
                ...
                if (answer == "y")
                {
                    ...
                    // older devices waste more standby power
        ...
        // STEP 3
        // Calculates wasted energy and cost
        static void HiddenCostCalculator()
        {
            ...
            // converts watts into monthly kWh
